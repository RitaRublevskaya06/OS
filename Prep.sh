#!/bin/bash
echo "Создание структуры каталогов для лабораторной работы..."
...
# В Linux скрытые директории начинаются с точки
...
# В Linux нет точных аналогов атрибутов Windows, но можно установить права
chmod 444 task_01b/readonly.txt 2>/dev/null || touch task_01b/readonly.txt && chmod 444 task_01b/readonly.txt
